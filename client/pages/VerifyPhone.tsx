...
export default function VerifyPhone() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!formData.phone.trim() || !formData.otpCode.trim()) {
      ...
      setMessage({
        type: "success",
        text: "Phone verified successfully! Redirecting to homepage...",
      });
        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6 text-center space-y-4">
            ...
            <p className="text-green-700">
              Your phone number has been successfully verified. You will be
              redirected shortly.
            </p>
          </CardContent>
        </Card>
